...
import useGetActivityType from "../../../../hooks/data/get_typeactivity";
...
import CreateActivityTypePage from "../../pages/create";
import ActivityTypePage from "../../pages/update";
import { useTranslation } from "react-i18next";

interface TableViewProps {
  columns: ColumnDef<ActivityType, unknown>[];
...
const TableView: React.FC<TableViewProps> = (props) => {
  ...
  const title = t("typeActivities");
  const loader = useLoader();
  const type = useGetActivityType();
  const data = type.data as Array<ActivityType>;
