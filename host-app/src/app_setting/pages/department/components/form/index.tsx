...
import { FormDepartment } from './types/department_form';
import { FormProps } from '@apptypes/form_type';


const FormDepartmentView: React.FC<FormProps<FormDepartment>> = ({ title, name, data, handlerSave, isDeletable, handlerDelete }) => {

    const loader = useLoader();
    const { closeModal } = useModal();

    const onSubmit = (person: FormDepartment) =>
        handlerSave(person);
...
export default FormDepartmentView;