  ...
  return (
    <div className="mt-6">
      <p className="text-gray-700 text-lg leading-8">
        ...
        Por favor, revise su cuenta. Le hemos enviado un mensaje a su correo
        electrónico con el detalle de la solicitud. También le recomendamos
        verificar la carpeta de spam, ya que es posible que el mensaje se
        encuentre allí.
      </p>
...
const NotificationIcon = () => {
  return (
    <div className="flex justify-center my-8">
      ...
      <div className="relative w-24 h-24 bg-green-100 rounded-full shadow-lg flex items-center justify-center">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        {/* Efecto Animado */}
        <div className="absolute inset-0 bg-green-300 rounded-full opacity-20 animate-ping"></div>
      </div>
    </div>
  );
};
...
const ActionButtons = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      {/* Botón 1 */}
      <button
        onClick={() => alert("Ver detalles de la solicitud")}
