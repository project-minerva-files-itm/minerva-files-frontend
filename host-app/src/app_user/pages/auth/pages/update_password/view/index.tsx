...
const UpdatePasswordView: React.FC<UpdatePasswordViewProps> = ({ data, handlerSave }) => {
  ...
  const requiredFields: (keyof ResetPasswordType)[] = ['currentPassword', 'newPassword', 'confirm'];
